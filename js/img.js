$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="Memories2.html" style="text-decoration: none;color: #fff;background: #caabd8;display: inline-block;padding: 10px;border: 2px solid #fff;border-radius: 30px;font-size:40px">开启独家记忆</a>');
            $('.begin').fadeIn();
            return;
        }
    };
